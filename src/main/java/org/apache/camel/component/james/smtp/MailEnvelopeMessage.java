 ...
 * 
 * The sender, recipient list and message size get stored in the headers. The
 * message itself get stored a {@link InputStream} in the body
 * 
 */
public class MailEnvelopeMessage extends DefaultMessage {

	/**
	 * String representation of the sender specified in the mail from
	 * transmission.
	 */
	public final static String SMTP_SENDER_ADRRESS = "SMTP_SENDER_ADDRESS";

	/**
	 * String representation of the recipients specified in the rcpt to
	 * transmissions. The recipients are comma-seperated
	 */
